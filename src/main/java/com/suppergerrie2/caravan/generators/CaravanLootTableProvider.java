...
public class CaravanLootTableProvider extends LootTableProvider {
    public CaravanLootTableProvider(DataGenerator generator) {
        super(generator);
    }
    ...
    protected @NotNull List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> getTables() {
        return List.of(
                Pair.of(CaravanBlockLoot::new, LootContextParamSets.BLOCK)
        );
    }
